...
const EmailSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (response.status === 200) {
      ...
      // Hide success message after a certain delay (e.g., 3 seconds)
      setTimeout(() => {
    ...
    <section id="contact" className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
      ...
      <div className="z-10">
        ...
        <div className="socials flex gap-2">
          <Link href="https://github.com/cesar33-creator">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="mailto:cesarrais33@gmail.com">
            <Image src={GmailIcon} alt="Gmail Icon" />
          </Link>
          <Link href="https://www.instagram.com/cesarrraa/">
        ...
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input name="email" type="email" id="email" required className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder="cesar@google.com" />
            </div>
            <div className="mb-6">
